...
EOF
	...
	python_files=$(find . -not \( -path ./lib -prune \) -type f -iname "*.py")
	header_files=$(find . -not \( -path ./lib -prune \) -type f \( -iname "*.h" -o -iname "*.hh" -o -iname "*.hpp" \))
	source_files=$(find . -not \( -path ./lib -prune \) -type f \( -iname "*.c" -o -iname "*.cc" -o -iname "*.cpp" \))
	...
	text_files=$(find . -not \( -path ./lib -prune \) -type f \( -iname "*.txt" -o -iname "*.md" \))
...
title="Selected Topics in Programming exam project"
